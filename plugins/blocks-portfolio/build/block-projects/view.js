...
document.addEventListener("DOMContentLoaded", () => {
  document.querySelectorAll(".isotope-layout").forEach(container => {
    ...
    if (!grid) return;
    const iso = new (isotope_layout__WEBPACK_IMPORTED_MODULE_0___default())(grid, {
      ...
      masonry: {
        ...
        // change to ".portfolio-item" if needed
        gutter: 0
      }
    });
    ...
    const imgLoad = imagesloaded__WEBPACK_IMPORTED_MODULE_1___default()(grid);
